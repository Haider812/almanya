 ...
 .factory('Place', function ($q, moment) {
    ...
    count: function (params) {
      ...
      return defer.promise;
			   ...
			   Object.defineProperty(Place.prototype, 'videoUrl', {
        get: function () {
            return this.get('videoUrl');
        },
        set: function (value) {
            this.set('videoUrl', value);
        }
    });
	
	   Object.defineProperty(Place.prototype, 'offerOne', {
        get: function () {
            return this.get('offerOne');
        },
        set: function (value) {
            this.set('offerOne', value);
        }
    });

	   // Object.defineProperty(Place.prototype, 'offerOneColor', {
        // get: function () {
            // return this.get('offerOneColor');
        // },
        // set: function (value) {
            // this.set('offerOneColor', value);
        // }
    // });
		
	Object.defineProperty(Place.prototype, 'offerTwo', {
        get: function () {
            return this.get('offerTwo');
        },
        set: function (value) {
            this.set('offerTwo', value);
        }
    });

	 // Object.defineProperty(Place.prototype, 'offerTwoColor', {
        // get: function () {
            // return this.get('offerTwoColor');
        // },
        // set: function (value) {
            // this.set('offerTwoColor', value);
        // }
    // });
	
    Object.defineProperty(Place.prototype, 'offerThree', {
        get: function () {
            return this.get('offerThree');
        },
        set: function (value) {
            this.set('offerThree', value);
        }
    });
	
	// Object.defineProperty(Place.prototype, 'offerThreeColor', {
        // get: function () {
            // return this.get('offerThreeColor');
        // },
        // set: function (value) {
            // this.set('offerThreeColor', value);
        // }
    // });
