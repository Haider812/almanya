'use strict';
 ...
 function ($scope, $mdDialog, $mdToast, Place, Category, Auth, Sonderangebot) {
  ...
  var loadSonderangebote = function () {
    var params = {
      page: 1, limit: 1000, filter: '', order: 'title'
    }

    Auth.ensureLoggedIn().then(function () {
      Sonderangebot.all(params).then(function (sonderangebote) {
  ...
  $scope.onUpdateIsApproved = function (place, isApproved) {
    ...
    Place.update(place).then(function (success) {
 	...
 	$scope, $mdDialog, $mdToast, Place, Category, File, NgMap, GeoCoder, place, Sonderangebot) {

 	var marker, map;

 	$scope.categories = [];
	$scope.sonderangebote = []; /*ANGEBOTE*/
 	$scope.place = {};
  ...
  /*ANGEBOTE*/
  Sonderangebot.all({ page: 1, limit: 1000, filter: '' })
  .then(function (sonderangebote) {
    $scope.sonderangebote = sonderangebote;
  });
  /*ANGEBOTE*/
